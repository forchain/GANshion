'''Trains ACGAN on GANshion using Keras
...
from tensorflow.keras.datasets import cifar10 as GANshion
...
def build_and_train_models():
    ...
    """
    # load GANshion dataset
    (x_train, y_train), (_, _) = GANshion.load_data()
